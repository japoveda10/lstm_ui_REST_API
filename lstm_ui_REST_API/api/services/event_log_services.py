...
from . import log_reader as lr
from . import role_discovery as rl
from . import nn_support as nsup
...
def load_event_log(parms):
    ...
    log = lr.LogReader('/Users/japg/Documents/GitHub/lstm_ui_REST_API/lstm_ui_REST_API/api/services/input_files/ConsultaDataMining201618.xes.gz', parms['read_options'])
...
def kernel():
    ...
    column_names = {'Case ID': 'caseid', 'Activity': 'task','lifecycle:transition': 'event_type', 'Resource': 'user'}
